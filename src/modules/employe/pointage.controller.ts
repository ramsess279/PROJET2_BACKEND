...
const PointageController = {
  ...
  findByEmploye: async (req: Request, res: Response) => {
    try {
  ...
  findByEntreprise: async (req: Request, res: Response) => {
    try {
  ...
  generateCompanyQRCode: async (req: Request, res: Response) => {
    try {
      const { entrepriseId } = req.params;
  ...
  canCheckIn: async (req: Request, res: Response) => {
    try {
      const { employeId } = req.params;
  ...
  getStats: async (req: Request, res: Response) => {
    try {
      ...
      const stats = await PointageService.getStats(employeId as string, start, end);
...
const PresenceController = {
  ...
  calculateMonthlyHours: async (req: Request, res: Response) => {
    try {
      ...
      const stats = await PresenceService.calculateMonthlyHours(
        employeId,
        parseInt(year),
        parseInt(month)
      );
  ...
  // Marquer une absence
  markAbsence: async (req: Request, res: Response) => {
    try {
      const { employeId } = req.params;
  ...
  // Marquer un congé
  markLeave: async (req: Request, res: Response) => {
    try {
      const { employeId } = req.params;
