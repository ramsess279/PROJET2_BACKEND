...
const PointageModel = {
  ...
  update: async (id: string, data: Partial<Pointage>) => {
...
const PresenceModel = {
  ...
  findByEmployeAndDate: async (employeId: string, date: Date) => {
  ...
  update: async (id: string, data: Partial<Presence>) => {
  ...
  upsert: async (employeId: string, date: Date, data: Partial<Presence>) => {
    const startOfDay = new Date(date);
    startOfDay.setHours(0, 0, 0, 0);
  ...
  calculateWorkedHours: async (employeId: string, date: Date) => {
    const startOfDay = new Date(date);
    startOfDay.setHours(0, 0, 0, 0);
    const endOfDay = new Date(date);
    endOfDay.setHours(23, 59, 59, 999);
